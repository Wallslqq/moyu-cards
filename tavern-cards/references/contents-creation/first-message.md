...
> 本节为流程挂钩与要点摘要；完整方法论（含开场事实建立、整理稿与修改流程）见 `references/contents-creation/opening-style.md`，两处不一致时以该篇为准。
...
> 完整表述见 `references/contents-creation/opening-style.md`「使用者边界」「控制篇幅与信息」两节。
